...
public final class JetTemplateViewHandler extends AbstractTemplateViewHandler {
    ...
    protected void doRender(AstCodeVisitor vistor,Directive_define_expressionContext context) throws IOException {
    	vistor.visitDirective_define_expression(context);
    }
}
